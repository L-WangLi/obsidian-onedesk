...
- **A session that runs past midnight is split at 24:00**, the rest credited to the next day. An activity started with nothing after it is treated as a forgotten End and not counted.
